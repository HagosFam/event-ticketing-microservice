package com.microservice.kafka.consumer.config;

import com.microservice.kafka.data.KafkaConfigData;
import com.microservice.kafka.data.KafkaConsumerConfigData;
...
@Configuration
@ComponentScan(basePackages = "com.microservice.kafka.data")
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String,Object> consumerConfigs(){
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,kafkaConsumerConfigData.getKeyDeserializer());
        ...
        props.put(ConsumerConfig.HEARTBEAT_INTERVAL_MS_CONFIG,kafkaConsumerConfigData.getSessionTimeoutMs());
